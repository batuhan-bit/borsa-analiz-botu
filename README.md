...
verisi (Alpha Vantage) + bağımsız web duygusu (Finnhub, ücretsiz opsiyonel
...
├── data/              # Alpaca · yfinance · Alpha Vantage · Finnhub istemcileri
...
| `FINNHUB_API_KEY` | Opsiyonel | Yoksa çapraz doğrulama atlanır, yalnızca AV kullanılır (ücretsiz — [finnhub.io/register](https://finnhub.io/register)) |
